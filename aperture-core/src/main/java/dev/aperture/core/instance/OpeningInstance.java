...
public record OpeningInstance(
	...
	public OpeningInstance withParameters(ParameterSet newParameters) {
		return new OpeningInstance(
			schemaVersion,
			instanceId,
			typeId,
	...
	public static final class Builder {
		...
		private Transform3d transform = Transform3d.at(0, 0, 0, dev.aperture.geometry.primitives.Facing.NORTH);
