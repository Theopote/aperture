...
public final class DefaultSelectionModel implements SelectionModel {
	...
	public void selectComponent(ArchitecturalObjectId id, ComponentPath path) { Objects.requireNonNull(id); ids.clear(); ids.add(id); primary=id; component=new ComponentSelection(id,Objects.requireNonNull(path)); changed(); }
