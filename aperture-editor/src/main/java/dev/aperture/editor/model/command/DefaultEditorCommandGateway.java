...
public final class DefaultEditorCommandGateway implements EditorCommandGateway {
	private final EditorCommandTransport transport; private final DiagnosticsModel diagnostics;
	public DefaultEditorCommandGateway(EditorCommandTransport transport, DiagnosticsModel diagnostics){this.transport=Objects.requireNonNull(transport);this.diagnostics=Objects.requireNonNull(diagnostics);}
