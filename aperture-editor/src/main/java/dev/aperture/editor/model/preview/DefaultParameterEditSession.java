...
public final class DefaultParameterEditSession implements ParameterEditSession {
	...
	public EditorCommandSubmission commit(){ensureActive();active=false;var result=gateway.submit(new SetParameterArchitecturalCommand(id,key,preview),revision);previews.clear(id,key);return result;}
