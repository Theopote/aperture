...
public final class DefaultParameterEditSession implements ParameterEditSession {
	...
	public EditorCommandSubmission commit(){ensureActive();active=false;var result=gateway.submit(new SetParameterArchitecturalCommand(id,key,preview),revision);if(result.status()!=EditorCommandSubmission.Status.PENDING)previews.clear(id,key);return result;}
